...
from marketdata_api.models.utils.cfi import CFI, Category
...
class CFIInstrumentTypeManager:
    ...
    CFI_TO_FITRS_MAPPING = {
        Category.COLLECTIVE_INVESTMENT: ['FULNCR_', '_C_', 'FULECR_'],   # Both equity and non-equity CIVs
    ...
    @classmethod
    def create_cfi_from_firds_context(cls, firds_file_letter: str, group: str = 'S', attributes: str = 'XXXX') -> str:
        """
    ...
    def validate_cfi_consistency(cls, cfi_code: str, firds_file_letter: str) -> Tuple[bool, str]:
        ...
        if actual_category != expected_letter:
            return False, f"CFI category '{actual_category}' doesn't match FIRDS file '{firds_file_letter}' (expected '{expected_letter}')"
