...
def get_entity(lei):
    ...
    try:
        ...
        if not entity:
            return (
                jsonify({ResponseFields.ERROR: ErrorMessages.ENTITY_NOT_FOUND}),
...
def create_or_update_entity(lei):
    ...
    try:
        ...
        if not entity:
            return (
                jsonify({ResponseFields.ERROR: ErrorMessages.FAILED_TO_CREATE_ENTITY}),
...
def delete_entity(lei):
    ...
    try:
        ...
        return jsonify({ResponseFields.MESSAGE: SuccessMessages.ENTITY_DELETED, DbFields.LEI: lei})
