...
def create_transparency_models(api, common_models):
    ...
    transparency_base = api.model(
        "TransparencyBase",
        {
            ...
            "file_type": fields.String(
                required=True,
                description="FITRS file type",
                enum=[
                    "FULECR_C",
                    "FULECR_E",
                    "FULECR_R",  # Equity types
                    "FULNCR_C",
                    "FULNCR_D",
                    "FULNCR_E",
                    "FULNCR_F",
                    ...
                    "FULNCR_I",
                    "FULNCR_J",
                    "FULNCR_O",  # Non-equity types
                ],
            ),
            "instrument_category": fields.String(
                description="Instrument category (C, D, E, F, H, I, J, O, R)"
            ),
            "is_equity": fields.Boolean(description="Whether this is equity transparency data"),
            "is_non_equity": fields.Boolean(
                description="Whether this is non-equity transparency data"
            ),
            "is_debt_instrument": fields.Boolean(
                description="Whether this is specifically a debt instrument"
            ),
            "is_derivatives_or_complex": fields.Boolean(
                description="Whether this is derivatives or complex instruments"
            ),
            "instrument_classification": fields.String(
            ...
            "total_transactions_executed": fields.Integer(
                description="Total number of transactions executed"
            ),
            "total_volume_executed": fields.Float(
                description="Total volume of transactions executed"
            ),
            "has_transaction_data": fields.Boolean(
                description="Whether record has transaction data"
            ),
    ...
    transparency_details = api.model(
        "TransparencyDetails",
        {
            "type": fields.String(
                required=True,
            ...
            "financial_instrument_classification": fields.String(
                description="Financial instrument classification (equity only)"
            ),
            "methodology": fields.String(description="Methodology used (equity only)"),
            "average_daily_turnover": fields.Float(
                description="Average daily turnover (equity only)"
            ),
            "large_in_scale": fields.Float(description="Large in scale threshold (equity only)"),
            "average_daily_number_of_transactions": fields.Float(
                description="Average daily number of transactions (equity only)"
            ),
            "average_transaction_value": fields.Float(
                description="Average transaction value (equity only)"
            ),
            ...
            "underlying_isin": fields.String(
                description="Underlying instrument ISIN (futures only)"
            ),
            "is_stock_dividend_future": fields.Boolean(
                description="Stock dividend future indicator (futures only)"
            ),
            "pre_trade_large_in_scale_threshold": fields.Float(
                description="Pre-trade large in scale threshold (non-equity)"
            ),
            "post_trade_large_in_scale_threshold": fields.Float(
                description="Post-trade large in scale threshold (non-equity)"
            ),
    ...
    transparency_detailed = api.inherit(
        "TransparencyDetailed",
        transparency_base,
        {
            "details": fields.Nested(
                transparency_details, description="Type-specific transparency details"
            ),
    ...
    transparency_list_response = api.model(
    ...
    transparency_detail_response = api.model(
    ...
    transparency_create_request = api.model(
    ...
    batch_transparency_request = api.model(
        "BatchTransparencyRequest",
        {
            "file_type": fields.String(
                description="FITRS file type filter",
                enum=[
                    "FULECR_C",
                    "FULECR_E",
                    "FULECR_R",
            ...
            "instrument_category": fields.String(
                description="Instrument category filter (C, D, E, F, H, I, J, O, R)"
            ),
            ...
            "isin_prefix": fields.String(
                description="ISIN prefix filter (e.g., 'NL' for Netherlands)"
            ),
            "limit": fields.Integer(
                description="Maximum number of calculations to create", default=10
            ),
            "cfi_type": fields.String(
                description="CFI type filter (D, F, E)", enum=["D", "F", "E"]
            ),
        },
    )

    # Batch create transparency request
    batch_create_transparency_request = api.model(
        "BatchCreateTransparencyRequest",
        {
            "records": fields.List(
                fields.Nested(transparency_create_request),
                required=True,
    ...
    transparency_statistics = api.model(
        "TransparencyStatistics",
        {
            ...
            "coverage_stats": fields.Nested(
                api.model(
                    "CoverageStats",
                    {
                        "instruments_with_transparency": fields.Integer(
                            description="Instruments with transparency data"
                        ),
                        "unique_isins": fields.Integer(
                            description="Unique ISINs in transparency data"
                        ),
                        "date_range": fields.Nested(
                            api.model(
                                "DateRange",
                                {
                                    "earliest": fields.Date(
                                        description="Earliest transparency date"
                                    ),
    ...
    transparency_statistics_response = api.model(
        "TransparencyStatisticsResponse",
        {
            "status": fields.String(required=True, description="Response status", enum=["success"]),
