...
from ...models.sqlite.legal_entity import LegalEntity, EntityAddress, EntityRegistration, EntityRelationship
...
class LegalEntityService(LegalEntityServiceInterface):
    ...
    def get_all_entities(self, limit: Optional[int] = None, offset: Optional[int] = None, filters: Optional[Dict[str, Any]] = None) -> Tuple[Session, List[object]]:
        """
    ...
    def _update_entity_addresses(self, entity: object, addresses_data: List[Dict[str, Any]]) -> None:
    ...
    def _update_entity_registration(self, entity: object, registration_data: Dict[str, Any]) -> None:
