...
class Instrument(Base):
    ...
    figi_mappings = relationship("FigiMapping", back_populates="instrument", cascade="all, delete-orphan", passive_deletes=True)  # Changed to plural, removed uselist=False to allow multiple FIGIs
