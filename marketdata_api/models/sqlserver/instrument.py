...
from sqlalchemy import Column, String, DateTime, Date, Boolean, Integer, Index, DECIMAL, Text
...
class SqlServerInstrument(SqlServerBase, InstrumentInterface):
    ...
    isin = Column(String(12), nullable=True, index=True)  # Removed unique constraint per migration plan
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.additional_data:
            try:
                additional = json.loads(self.additional_data) if isinstance(self.additional_data, str) else self.additional_data
    ...
    def update_from_dict(self, data: Dict[str, Any]) -> None:
        ...
        # Update basic fields
        basic_fields = ['isin', 'full_name', 'short_name', 'symbol', 'figi', 
