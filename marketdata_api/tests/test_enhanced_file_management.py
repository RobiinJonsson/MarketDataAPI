...
def test_file_management_service():
    ...
    try:
        ...
        filtered_files = service.get_files_with_filters(
            file_type='firds',
            limit=5
        )
...
def test_api_endpoints():
    ...
    endpoints_to_test = [
        ...
        ("/api/v1/esma-files?datasets=firds&date_from=2025-07-10&date_to=2025-07-15", "GET", None, "ESMA file listing"),
    ]
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if isinstance(result, dict) and 'error' not in result:
                    ...
                    if endpoint.endswith('/files') and '?' not in endpoint and isinstance(result, dict) and 'firds' in result:
