        ...
        def get(self, lei):
            ...
            try:
                ...
                result = {
                    ...
                    } if hasattr(entity, 'first_address_line') else None,
                    "registration": {
                        "initial_registration_date": entity.initial_registration_date.isoformat() if entity.initial_registration_date else None,
                        "last_update_date": entity.last_update_date.isoformat() if entity.last_update_date else None,
                    ...
                    } if hasattr(entity, 'initial_registration_date') else None
                }
